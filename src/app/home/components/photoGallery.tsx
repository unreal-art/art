        ...
        {isVisible ? (
          mediaType === 'VIDEO' ? (
            <div className="relative w-full h-full">
              ...
              />
              {/* Video indicator overlay with modern design */}
              <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/40 opacity-70 transition-opacity duration-200 group-hover:opacity-100">
